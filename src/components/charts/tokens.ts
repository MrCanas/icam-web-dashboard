/**
 * Paleta y constantes de las gráficas del portal.
 *
 * Nacieron en el tab Corporativas y se promovieron a compartidas cuando
 * Inversores necesitó la misma paleta: importarlas desde otro módulo es lo que
 * ARCHITECTURE.md no quiere. `src/modules/corporativo/ui/charts/tokens.ts`
 * sigue existiendo como re-export.
 *

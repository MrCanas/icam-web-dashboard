...
import { PmDeviationTable } from "@/components/pm/PmDeviationTable";
import { PmGanttProject } from "@/components/pm/PmGanttProject";
import { PmSnapshotEvolutionChart } from "@/components/pm/PmSnapshotEvolutionChart";
...
import { fetchPmActivoBySlug } from "@/lib/pm-queries";
...
export default async function PmProyectoDetailPage({ params, searchParams }: PageProps) {
  ...
  const { row, error } = await fetchPmActivoBySlug(supabase, id);

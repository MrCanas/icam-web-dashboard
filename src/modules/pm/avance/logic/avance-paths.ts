...
/**
 * El avance de un proyecto vive ahora como primera sección de su acta. La ruta
 * /avance-obra sigue viva como rescate, pero los enlaces apuntan aquí.
 */
...
export function avanceEnActaPath(idActivo: string): string {
  return `/dashboard/pm/proyecto/${encodeURIComponent(idActivo)}/actas?tab=acta`;
}

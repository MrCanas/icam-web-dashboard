export function MethodologyNotes() {
  return (
    <section className="bg-subtle rounded-lg border border-subtle p-3 sm:p-4 text-sm text-text-muted space-y-2">
      <p>Datos basados en fila representativa por proyecto (Es Ultima Fila = 1).</p>
